...
from game.game import Game, TrajectoryRunner, OracleRunner
...
class MonopolyOracleRunner(OracleRunner):
    def __init__(self, game, random_init_func, T, clear_size, log_freq=0, log_prefix="", T_eval=0):
        super(__class__, self).__init__(game=game, random_init_func=random_init_func)
        self.T = T
        self.T_eval = T_eval
        self.clear_size = clear_size
