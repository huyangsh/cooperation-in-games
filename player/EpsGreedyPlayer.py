...
class EpsGreedyPlayer(Player):
    def __init__(self, pid, actions, alpha, eps, gamma, horizon, log_freq=0):
        self.pid = pid
        ...
        self.setting = f"PLAYER {pid}: EpsGreedyPlayer\n"
        self.setting += f"  alpha = {alpha}, eps = {eps}, gamma = {gamma}, horizon = {horizon},\n"
